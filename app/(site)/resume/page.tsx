...
const about = {
  title: "About Me",
  description:
    "I am a software engineer with a passion for building web applications. I have experience in front-end and back-end development, and I am always eager to learn new technologies and improve my skills.",
  info: [
    {
      fieldName: "Name",
...
const education = {
  ...
  title: "My Education",
  description:
    "I believe education is a lifelong endevour even after graduation from University.  Learning never stops.",
  items: [
    {
...
const skills = {
  title: "My Skills",
  description:
    "I have a diverse set of skills that I have acquired through my education, continual learning, and work experience.",
  items: [
    {
      icon: <SiPython />,
      name: "Python",
    ...
    },
    {
      ...
      name: "NextJS",
      color:
        "border border-transparent group-hover:text-black group-hover:bg-white rounded-full",
    },
    {
      icon: <FaNodeJs />,
      name: "NodeJS",
            ...
            <TabsContent value="skills" className="w-full h-full">
              <div className="flex flex-col gap-[30px">
                ...
                <ScrollArea className="relative h-[400px] px-3">
                  <div className="absolute bottom-0 w-full h-[20px] z- bg-gradient-to-b from-transparent to-background" />
                  <div className="absolute top-0 w-full h-[20px] z-50 bg-gradient-to-t from-transparent to-background" />
