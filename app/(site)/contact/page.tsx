        ...
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form
              ...
              className="flex flex-col gap-6 p-10 clay bg-[#27272c] rounded-xl"
            >
              ...
              {success ? (
                ...
                >
                  {loading ? (
                    <>
                      <LucideLoaderCircle className="animate-spin text-primary-foreground" />
                      Sending...
                    </>
                  ) : (
                    "Send Message"
              ...
              {info.map((item, index) => {
                return (
                  <li key={index} className="flex items-center gap-6">
                    <div className="w-[52px] h-[52px] xl:w-[72px] xl:h-[72px] clay bg-[#27272c] text-accent rounded-full transition-all duration-300 flex items-center justify-center">
