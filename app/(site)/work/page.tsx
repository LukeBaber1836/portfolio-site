                    ...
                    <TooltipProvider delayDuration={100}>
                      <Tooltip>
                        <AlertDialog>
                          ...
                          <AlertDialogContent className="bg-background max-w-3xl max-h-[80vh] overflow-y-auto scrollbar-hide">
                            ...
                            <div className="flex justify-center pt-4">
                              <AlertDialogCancel className="bg-red-500/10 text-red-500 border-red-500 font-semibold px-8 py-2 rounded-full transition-all duration-300 w-full hover:bg-red-500/30 hover:text-white hover:cursor-pointer">
                                Close
                              </AlertDialogCancel>
                            </div>
                          </AlertDialogContent>
          ...
          <div className="w-full xl:w-1/2">
            ...
            >
              ...
              <WorkSliderBtns
                ...
                btnStyles="clay bg-background group hover:bg-accent text-accent hover:text-primary-foreground text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all duration-300 rounded-full hover:cursor-pointer"
                iconStyles="text-[28px] text-accent group-hover:text-primary-foreground"
              />
            </Swiper>
          </div>
        </div>
