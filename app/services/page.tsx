          ...
          {services.map((service, index) => {
            return <div 
              ...
              <div className='w-full flex justify-between items-center'>
                ...
                <Link href={service.href} className='w-[70px] h-[70px] rounded-full bg-white group-hover:bg-accent transition-all duration-500 ease-in-out flex justify-center items-center hover:-rotate-45 hover:scale-105'>
